...
from src.config import TICKERS, NUM_QUARTERS_TO_FETCH, PROCESSED_FILINGS_PATH, RAW_FILINGS_PATH
...
if st.button("Step 3: Engineer Features", use_container_width=True):
    try:
        ...
        run_step_with_logging(engineer_features, processed_filings_df=processed_df)
    except FileNotFoundError:
